...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    AccountController *left = [[AccountController alloc] initWithStyle:UITableViewStylePlain];
    UINavigationController* nl = [[UINavigationController alloc]initWithRootViewController:left];
    [self.revealSideViewController preloadViewController:nl forSide:PPRevealSideDirectionLeft];
    HC_RELEASE(left);
    
    ShoppingListController* slController = [[ShoppingListController alloc] initWithStyle:UITableViewStylePlain];
    UINavigationController* nr = [[UINavigationController alloc]initWithRootViewController:slController];
    [self.revealSideViewController preloadViewController:nr forSide:PPRevealSideDirectionRight];
    HC_RELEASE(slController);
}
